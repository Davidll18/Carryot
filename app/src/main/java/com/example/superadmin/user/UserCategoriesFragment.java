...
import com.example.superadmin.adapters.UserCategoryAdapter;

import java.util.Arrays;
import java.util.List;

public class UserCategoriesFragment extends Fragment implements UserCategoryAdapter.OnItemClickListener{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        UserCategoryAdapter adapter = new UserCategoryAdapter(categories, this);
