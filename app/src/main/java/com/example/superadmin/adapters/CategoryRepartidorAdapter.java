...
public class CategoryRepartidorAdapter extends RecyclerView.Adapter<CategoryRepartidorAdapter.CategoryViewHolder> {

    private List<String> categories;
    private OnItemClickListener listener;

    public CategoryRepartidorAdapter(List<String> categories, OnItemClickListener listener) {
    ...
    public static class CategoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public CategoryViewHolder(View itemView) {
            super(itemView);
            textMenuName = itemView.findViewById(R.id.text_restaurante_name);
